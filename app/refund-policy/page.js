      ...
      <div className='my-10'>
        ...
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
            ...
            <li>Next contact your bank. There is often some processing time before a refund is posted. If you&apos;ve done all of this and you still have not received your refund yet, please contact us at marketing@digitalwolf.co.in.</li>
          </ul>
        </div>
        ...
        <div className='mx-auto px-28 mb-10'>
          <ul className="list-disc pl-5">
            <li>We only replace items if they are defective or damaged. If you need to exchange it for the same item, send us an email at marketing@digitalwolf.co.in and send your item to: 22/263, Jodhpur Park, Tagore Park Road, Kolkata: 700045</li>
          </ul>
        </div>
